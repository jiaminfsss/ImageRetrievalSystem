	...
	<div class="login-wrap">
		<el-form class="login-container">
			...
			<el-row style="text-align: center;margin-top:-10px">
				<el-link type="primary" style="margin-right: 10px;">忘记密码</el-link>
...
export default {
  ...
  ,methods:{
	  ...
	  doSubmit(){
		//后台登录地址
		// let url = this.axios.defaults.baseURL+'/user/login';
		let params = {
			username: this.username,
			password: this.password
		};
		// this.$http.get(url, {params:params}).then(res=>{
		// 	if(res.data.code==200){ //登录成功状态码
		// 		this.$message({
		...
		if ((this.username === 'fsjm' && this.password === '123456') || (this.username === 'dyb' && this.password === '123456')) {
			this.$router.push('/home'); //登录成功跳转到首页
		}else{
